...
log:debug("loaded villagebus.modules.http") 
...
--[[ evaluate ]]------------------------------------------------------------
function evaluate(request, response) -- request = { verb, path, query, data }, response = luci.http
  ...
  response.prepare_content(headers["content-type"] or "text/plain")
